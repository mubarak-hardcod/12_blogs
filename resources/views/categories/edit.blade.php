        ...
        <div class="row justify-content-center">
            <div class="col-md-4">
                ...
                @if(session('success'))
                    ...
                    <div class="card-body">
                        <form action="{{ route('categories_update',$datas->id) }}" method="POST"  enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="d-grid mx-auto">
                             ...
                             <a class="btn btn-primary  " href="{{ url('categories_index/')}}" role="button" >Back </a>
